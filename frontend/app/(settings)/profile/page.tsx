...
export default function SettingsProfilePage() {
  ...
  const { user, sid, setUser } = useUser();
  ...
  async function deleteAccount() {
    ...
    try {
      ...
      toast.info("Dein Account wurde erfolgreich gelöscht.");
      setUser(null)
      router.push("/");
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          {user ? (
            ...
            <div
              className={
                "w-full h-full flex flex-col justify-center items-center gap-y-6"
              }
            >
      ...
      {user ? (
        <Button
          className={
            "w-full text-center items-center bg-red-600 text-primary hover:bg-red-700"
          }
      ...
      <ConfirmationDialog
        description={
          "Dies wird deinen Account und alle dazu gehörigen Infos unwiederruflich löschen!"
        }
