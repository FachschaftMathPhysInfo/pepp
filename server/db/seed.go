...
func SeedData(ctx context.Context, db *bun.DB) error {
	...
	settings := []*models.Setting{
		...
		{Key: "email-application-subject", Value: "Registrierung zu Vorkurs Programm", Type: "STRING"},
		...
		{Key: "email-application-denied-intro", Value: "wir mussten deine Registrierung zum Programm leider ablehnen.", Type: "STRING"},
		{Key: "email-application-denied-outro", Value: "Du hast im Vergleich zu anderen besser abgeschnitten und wir haben uns daher entschieden, dass du das Programm nicht benötigst. Sollten weitere Plätze frei werden, informieren wir dich umgehend!", Type: "STRING"},
